    ...
    private void cadastrarAluno() {
        ...
        call.enqueue(new Callback<Aluno>() {
            ...
            public void onResponse(Call<Aluno> call, Response<Aluno> response) {
                if (response.isSuccessful()) {
                    ...
                    try {
                        ...
                        Toast.makeText(CadastroActivity.this, "Erro ao cadastrar aluno: " + errorBody, Toast.LENGTH_LONG).show();
                    } catch (Exception e) {
                        e.printStackTrace();
            ...
            public void onFailure(Call<Aluno> call, Throwable t) {
                Toast.makeText(CadastroActivity.this, "Falha na comunicação com o servidor: " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
